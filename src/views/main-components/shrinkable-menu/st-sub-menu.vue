<template>
  <li :class="classes" @mouseenter="handleMouseenter" @mouseleave="handleMouseleave">
    <div :class="[prefixCls + '-submenu-title']" ref="reference" @click.stop="handleClick" :style="titleStyle">
      ...
      <svg-icon :type="svgType" style="float: right;"></svg-icon>
    </div>
...
import { getStyle, findComponentUpward, findComponentsDownward } from 'iview/src/utils/assist'
import Emitter from 'iview/src/mixins/emitter'
import mixin from 'iview/src/components/menu/mixin'

const prefixCls = 'st-menu'
