              ...
              <div class="form-panel">
                <el-form ref="form" :model="dataForm" size="mini">
                  <el-row class="form-line">
                    ...
                    <el-col :span="8">
                      <el-form-item label="票据注册号" v-if="dataForm.pjhm">
                    ...
                    <el-col :span="8">
                      <el-form-item label="票据名称" v-if="dataForm.pjhm">
                        <el-input v-model="dataForm.pjmc"
                                  readonly="readonly">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="8">
                      <el-form-item label="被没收人">
                        <el-input v-model="dataForm.bmsr" size="mini" readonly="readonly">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      var id = window.location.href.split('pjkjview/')[1];
      this.id = id;
      this.queryDataForm();
      this.queryTable();
    },
    ...
    methods: {
      ...
      queryTable() {
        ...
        this.$api.pjkj.querywzTable(param).then((res) => {
