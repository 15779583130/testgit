...
<template>
  <el-card class="box-card">
              ...
              <el-form ref="form" :inline="true" :model="filters" size="mini">
                <el-row class="form-line">
                  <el-col :span="19" style="display: flex;">
                    ...
                    <el-form-item label="完结日期" clase="large">
                      <el-date-picker
                        size="mini"
                        v-model="filters.zjsjq"
                ...
                <el-row class="form-line" v-show="more">
                  <el-row class="form-line">
                    ...
                    <el-form-item label="申请部门" >
                      <el-input v-model="filters.sqr_dept_name" size="mini" placeholder="请输入申请部门" @focus="chooseDept('1')" clearable=""></el-input>
                    </el-form-item>
                  ...
                  <el-row class="form-line">
                    ...
                    <el-form-item label="接收部门" prop="sqr_dept_name">
                      <el-input v-model="filters.jsqr_dept_name" size="mini" placeholder="请输入接收部门" @focus="chooseDept('2')" clearable=""></el-input>
                    </el-form-item>
                    <el-form-item label="物证编号" prop="bgyxm">
    ...
    <el-row>
      <el-col :span="24">
        <el-button type="success" icon="el-icon-download" v-access id="yktzExp" @click="daoChuYsong" size="mini">导出台账</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="tableData"  :span-method="objectSpanHeBing" :header-cell-style="{background:'#e6e6e6'}" size="mini" border style="width: 100%"
            ...
            <el-table-column prop="sfsa" label="案件类型" :show-overflow-tooltip="true" :formatter="formatSfsa" width="80">
            </el-table-column>
            <el-table-column prop="xyr" label="嫌疑人" :show-overflow-tooltip="true" width="80">
            </el-table-column>
            <el-table-column prop="lsh" label="移送流水号"  :show-overflow-tooltip="true" min-width="120">
            </el-table-column>
            <el-table-column prop="sqsj" label="申请时间" :formatter="dateFormat" :show-overflow-tooltip="true" min-width="150">
            </el-table-column>
            <el-table-column prop="zjsj" label="完结时间" :formatter="dateFormat" :show-overflow-tooltip="true" min-width="150">
            </el-table-column>
            ...
            <el-table-column prop="yssm" label="移送原因"  :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="jsqr_name" label="接收操作人"  :show-overflow-tooltip="true" min-width="100">
            </el-table-column>
            ...
            <el-table-column prop="wzyszt" label="物证移送状态" min-width="100px" :formatter="formatYszt" :show-overflow-tooltip="true">
            </el-table-column>
          </el-table>
          <br/>
          <div class="page">
  ...
  export default {
    ...
    methods: {
      daoChuYsong () {
        ...
        if(this.filters.zjsjq==null){
          this.filters.zjsjq=''
        }
        if(this.filters.zjsjz==null){
          this.filters.zjsjz=''
        }
        Object.assign(parms, this.filters)

        this.$api.ystz.exportYstz(parms).then((res) => {
          if (res.success == "true") {
      ...
      formatSfsa(row, column,cellValue, index) {
        var zjztFormat = cellValue;
        if (cellValue === '0') {
          zjztFormat = '行政案件'
        } else if (cellValue === '1') {
      ...
      chooseDept(type) {
        ...
        if(type=='1'){
          ...
          this.$api.ystz.getAllDept(param).then((res) => {
            if (res.success == "true") {
              this.treeData1 = res.data
              this.babmDialog = true;
            } else {
      ...
      findTable() {
       ...
       let timeComp2 = timeCompare(this.filters.zjsjq, this.filters.zjsjz)
              if (!timeComp2.status) {
       ...
       if(this.filters.sqsjq==null){
        ...
        this.$api.ystz.queryTable(parms).then((res) => {
