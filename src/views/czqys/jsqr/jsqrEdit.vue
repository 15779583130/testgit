...
<template>
  <div>
    <div style="background:#F6F6F6;text-align: center;margin-bottom:5px">
      ...
      <el-button size="mini" type="primary" @click="thjs" :disabled="efitdisable"><span class="iconfont icon-tuihui"></span>&nbsp;退回
      </el-button>
      ...
      <el-row>
                  ...
                  <el-row class="form-line">
                    ...
                    <el-col :span="8">
                      <el-form-item label="任务单号">
                        <el-input v-model="formInline.ysbh" clearable
                                  @keyup.enter.native="onSubmit" readonly="readonly" style="width: 200px">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="申请部门" class="large">
                        <el-input v-model="formInline.sqr_dept_name" clearable
                                  @keyup.enter.native="onSubmit" readonly="readonly" style="width: 200px">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="申请人">
                        <el-input v-model="formInline.sqr_name" clearable
                                  @keyup.enter.native="onSubmit" readonly="readonly" style="width: 200px">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                      <el-form-item label="移送说明" class="large" style="margin-bottom: 30px;">
                        <el-input v-model="formInline.yssm" clearable type="textarea"
                    ...
                    <el-col :span="24">
                      <el-form-item label="附件" class="large" style="margin-bottom: 30px;">
                       <el-button type="success"  size="mini" @click="dialogUpLoadClick()">查看附件</el-button>
                      </el-form-item>
                    </el-col>
                  </el-row>
                </el-form>
        ...
        <el-col :span="24">
          <el-table ref="multipleTable" :data="tableData" :header-cell-style="{background:'#e6e6e6'}"
            ...
            <el-table-column prop="yszt" label="移送状态" width="100px" :formatter="formatYszt" :show-overflow-tooltip="true"></el-table-column>
          </el-table>
          <div class="page">
...
<script>
  ...
  export default {
    ...
    methods: {
      init() {
        this.formInline = JSON.parse(sessionStorage.getItem('bjysjsqr'))
        this.formInline.sqsj = timeFormat(this.$route.params.sqsj)
        if (this.formInline.yszt != '1') {
    ...
    caseThingName(wzxx_id) {
      ...
      findTable() {
        var param = {
          ...
          ysxxcb_id: this.formInline.id
        };
        this.$api.ysjsqr.querywzxxDetail(param).then((res) => {
      ...
      dialogUpLoadClick () {
        debugger
        this.isView = true
        this.ywid = this.formInline.ysxx_id
