          ...
          <el-tabs type="border-card" v-model="activeName">
            <el-tab-pane label="案件信息" name="caseInfo">
              <div class="divCaseInfo">
                <el-form :model="ajxxForm" label-position="right" label-width="80px" status-icon :rules="rules"
                         ref="ajxxForm"
                         class="demo-wzxxForm" size="mini">
                  <el-row>
                    <el-col :span="12">
                      <el-form-item label="案件编号" prop="ajbh">
                        <el-input v-model="ajxxForm.ajbh" :readonly="true" placeholder="请输入案件编号"
                                  size="mini"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-form-item label="文书图片" prop="wstp">
              ...
              <div style="float: right; position: relative;right: 12px">
              ...
              <el-row>
                          ...
                          <el-col :span="24">
                            <div class="grid-content bg-purple-dark">
                              <el-card class="box-card"
                                       style="width: 95%; margin: 0 auto; position: relative; top: 30px">
                                <el-tree
                                  class="filter-tree caseInfoText"
                                  :data="treeData"
                                  :props="treeProps"
                ...
                <el-button type="primary" size="mini" @click="chooseWllb()">确 定</el-button>
                  ...
                  <el-dialog
                    ...
                    width="70%"
                    style="">
                    <el-form :model="gxhxxForm" ref="gxhxxForm" label-width="180px" :rules="gxhxxRules" size="mini"
                        ...
                        <el-col :span="24">
                          <div class="grid-content bg-purple-dark"
                            ...
                            <el-form :model="wzxxForm" status-icon :rules="wzxxRules" ref="wzxxForm" label-width="100px"
                              ...
                              <el-row>
                                <el-col :span="12">
                                  <el-form-item label="物证编码" prop="wzbh">
                                    <el-input v-model="wzxxForm.wzbh"
                                              placeholder="请输入物证编码" size="mini" clearable></el-input>
                                  </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                  <el-form-item label="物证类别" prop="wzlbbm">
                                    ...
                                    <el-input v-model="wzxxForm.wzlb" placeholder="请选择物证类别" clearable
                                              @keyup.enter.native="onSubmit" @focus="chooseWzlb()" size="mini">
                                    </el-input>
                                  </el-form-item>
                                </el-col>
                              </el-row>
                              <el-row>
                                <el-col :span="12">
                                  <el-form-item label="物证名称" prop="wzmc">
                                    <el-input v-model="wzxxForm.wzmc"
                                              placeholder="请输入物证名称" size="mini" clearable></el-input>
                                  </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                  <el-form-item label="物证数量" prop="wzsl">
                                    <el-input v-model="wzxxForm.wzsl"
                              ...
                              <el-row>
                                <el-col :span="12">
                                  <el-form-item label="物证单位" prop="wzdw">
                                    <el-input v-model="wzxxForm.wzdw"
                                              placeholder="请输入物证单位" size="mini" clearable></el-input>
                                  </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                  <el-form-item label="入库状态" prop="state">
                                    <el-select class="inputWidth" v-model="wzxxForm.state" placeholder="请选择入库状态"
                                               :disabled="rkzdisabled">
                                      <el-option
                              ...
                              <el-row>
                                <el-col :span="8">
                                  <el-form-item label="是否涉案" prop="sfsa">
                                    <el-radio-group v-model="wzxxForm.sfsa" size="mini" style="width: 200px">
                              ...
                              <el-row>
                                <el-col :span="12" class="large">
                                  <el-form-item label="持有人" label-position="right" prop="xyr">
                                    <el-input v-model="wzxxForm.xyr" placeholder="请输入持有人" size="mini"
                                              clearable></el-input>
                                  </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                  <el-form-item label="规格型号" prop="ggxh">
                                    <el-input v-model="wzxxForm.ggxh"
                              ...
                              <el-row>
                                <el-col :span="24">
                                  <el-form-item label="特征描述" prop="wztz">
                                    <el-input
                                      type="textarea"
                                      :rows="2"
                                      placeholder="请输入特征描述"
                              ...
                              <el-row>
                                <el-col :span="24">
                                  <el-form-item label="物证照片" prop="wzzp">
                                    <el-tooltip class="item" effect="light" v-model="wzxxForm.wzzp" content="提示：格式仅允许上传（JPG,JPEG,PNG）"
                                                placement="right">
                              ...
                              <el-row>
                                <el-col :span="24">
                                  <div style="float: right; position: relative; top: -10px">
                                    <el-button type="primary" size="mini" icon="el-icon-plus" @click="saveWzxx('0')">
                                      保存并新增
                                    </el-button>
                                    <el-button type="primary" size="mini" icon="el-icon-check" @click="saveWzxx('1')">
                                      保存
                                    </el-button>
                                    <el-button type="primary" size="mini" icon="el-icon-close" @click="close()">关闭
                                    </el-button>
                                  </div>
                                </el-col>
                              </el-row>
  ...
  export default {
    data() {
      return {
        ...
        anJianImgZhongZhuan: [],
        srcListAnJian: [], // 案件图片
        imgListWuZheng: [], // 物证小图显示
        srcListWuZheng: [], // 物证大图显示
        picNum: '没有上传图片',
        // picNumWuZheng: '没有上传图片',
        anjianShangChuan: true,
        wzId: '',
        imgInfo: {},
        imgCount: '',
        baseImgList: [],
...
/*            wzzp: [{required: true, message: '这是必填字段', trigger: 'blur'}],*/
    ...
    methods: {
      ...
      // handlePictureCardPreviewAnJian (file) {
      ...
      handleRemove(file, fileList) { // 删除物证图片
        let fileRemove = file
        let self = this
        return this.$confirm('是否确定删除该图片 ?', '提示', {
          confirmButtonText: '确定',
        ...
        this.$api.upDataPic.getPicWuzheng({ywid: wuZhengId}).then(res => {
          if (res.trueOrFalse === 'false') {
            ...
            if (res.content === undefined) {
              ...
              if (self.fileWuZHeng.length === 0) {
                self.fileWuZHeng = res.content
              }
                self.fileWuZHeng = res.content
              for (let i = 0; i <= res.content.length; i++) {
                self.fileWuZHeng[i].url = res.content[i].file_path
              }
      ...
      init() {
        let self = this
        // if (JSON.parse(sessionStorage.getItem('editCaseInfo')).id) {
        //   this.anjianShangChuan = false
        // } else {
        //   this.anjianShangChuan = true
        // }
        if (this.$route.params.type === 'add') {
          ...
          var params = {id: JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId}
          this.activeName = JSON.parse(sessionStorage.getItem('editCaseInfo')).activeName
          this.getAnJianPic()
          this.findTree();
          this.$api.wzdj.get(params).then((res) => {
            self.$nextTick(() => {
      ...
      getAnJianPic() {
        let self = this
        var params = {
          ywid: JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId
        }
        this.$api.upDataPic.getPicWuzheng(params).then(res => {
          if (res.content.length >= 1) {
            ...
            self.srcListAnJian = res.content
            // if (self.srcListAnJian.length === 0) {
            //   self.srcListAnJian = res.content
            // }
            // for (let i = 0; i < res.content.length; i++) {
            //   self.srcListAnJian[i].url = res.content[i].file_path
            // }
          ...
          this.getBase64(file.raw).then(res => {
            ...
            self.$api.upDataPic.upDataPic(self.imgInfo).then(res => {
              if (res.content.data[0].success === 'true') {
                  self.$api.upDataPic.getPicWuzheng({ywid: this.wzId}).then(res => {
                  if (res.trueOrFalse === 'false') {
                    // self.$message.error('图片加载失败！');
                  } else {
                    self.$message({
      ...
      getBeforeUploadAnJian(file) {
        ...
        if (JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId) {
          this.imgInfo = {}
          this.baseImgList = []
          this.imgInfo.ywid = JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId
          this.imgInfo.filename = file.name
          this.imgInfo.filesize = file.size
          let self = this
          this.getBase64(file.raw).then(res => {
            ...
            self.$api.upDataPic.upDataPic(self.imgInfo).then(res => {
              if (res.content.data[0].success === 'true') {
                that.$api.upDataPic.getPicWuzheng({ywid: JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId}).then(res => {
                  if (res.trueOrFalse === 'false') {
                  } else {
                    that.$message({
                      message: '添加图片成功！',
      ...
      saveWzxx(type) {
        this.picNumWuZheng = '没有上传图片！'
        this.$refs.wzxxForm.validate((valid) => {
          if (valid) {
            let params = Object.assign({}, this.wzxxForm)
      ...
      findTree() {
        this.treeData = [];
        var param = {id: JSON.parse(sessionStorage.getItem('editCaseInfo')).anJianId};
