            ...
            <div class="text item">
              <el-form :inline="true" :model="filters" class="demo-form-inline" size="mini">
                ...
                <el-form-item label="*附件" label-width="90px" prop="fj" >
                  <el-link>预览<i class="el-icon-view el-icon--right"></i> </el-link>
...
export default {
  ...
  methods: {
    ...
    findFormData(){
      let ywzb_id =window.location.href.split('Yksqinfo/')[1];
      let parms={
        ywzb_id:ywzb_id
      }
      this.$api.yksq.queryDetail(parms).then(res => {
