      ...
      <el-col :span="24">
        <el-table :data="tableData" :span-method="objectSpanHeBing" :header-cell-style="{background:'#e6e6e6'}"
         ...
         <!-- <el-table-column type="selection" width="55"></el-table-column> -->
          ...
          <el-table-column prop="dwsl" label="数量及单位" min-with="100px" :show-overflow-tooltip="true"></el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
        if (sessionStorage.getItem('rkjjtzSession')) {
            this.filters = JSON.parse(sessionStorage.getItem('rkjjtzSession'))
        }
      this.init()
    },
    computed: {
    ...
    methods: {
      ...
      expRktz(){
        ...
        this.$api.entryTransferAccount.exportRktz(parms).then((res) => {
          if (res.success == "true") {
      ...
      beforeRouteLeave(to, form, next) {
          sessionStorage.removeItem('rkjjtzSession')
          sessionStorage.setItem('rkjjtzSession', JSON.stringify(this.filters))
          next()
      }
  }
</script>
