...
export const getMaxOrder = (params) => {
  return new Promise((resolve,reject)=>{
    http.post('/service/pzgl/cfwz', 'getMaxOrder', params, true, '').then((data)=>{
      resolve(data.getBody().getValueofBody());
    });
  })
}
...
export const get = (params) => {
  return new Promise((resolve,reject)=>{
    http.post('/service/pzgl/cfwz', 'getBeanByid', params, true, '').then((data)=>{
      resolve(data.getBody().getValueofBody());
    });
  })
}
...
export const saveOrupdate = (params) => {
  return new Promise((resolve,reject)=>{
    http.post('/service/pzgl/cfwz', 'saveOrupdate', params, true, '').then((data)=>{
      var obj ={
        "success": data.getHeader().getNode().getNodeItem('success'),
        "message":  data.getHeader().getNode().getNodeItem('message'),
        "data": null
